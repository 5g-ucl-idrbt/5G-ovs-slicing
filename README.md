...
sudo ip netns exec oai-spgwu ip r add 10.0.0.3/24 via 0.0.0.0 dev ${C1_IF}
sudo ip netns exec oai-spgwu ip r add 10.0.0.2/24 via 0.0.0.0 dev ${C1_IF}
sudo ip netns exec tomcat ip r add 10.0.0.1/24 via 0.0.0.0 dev ${C2_IF}
sudo ip netns exec router ip r add 10.0.0.1/24 via 0.0.0.0 dev ${C3_IF}
```
