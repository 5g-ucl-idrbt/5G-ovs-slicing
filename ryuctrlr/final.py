    ...
    def _packet_in_handler(self, ev):
        ...
        if (pkt.get_protocol(tcp.tcp) and pkt.get_protocol(tcp.tcp).dst_port == 9999):
            ...
            actions = [
                ...
                parser.OFPActionSetField(eth_dst="c6:3e:92:e6:b0:b1"), # SERVER MAC
                parser.OFPActionOutput(self.mac_to_port["c6:3e:92:e6:b0:b1"]) #SERVER MAC
            ...
            actions = [
                ...
                parser.OFPActionSetField(eth_src = "d6:0d:f2:82:82:fb"), # ROUTER MAC
                parser.OFPActionOutput(self.mac_to_port["1e:f0:17:87:3e:73"]) # OAI-SPGWU MAC
            ]
            self.add_flow(datapath, 2, match, actions)
            self._send_package(msg, datapath, in_port, actions)
